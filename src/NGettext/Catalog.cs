    ...
    public class Catalog : ICatalog
	{
			...
			: this(cultureInfo)
		{
			...
			catch (FileNotFoundException exception)
			{
				...
				Trace.WriteLine($"Translation file loading fail: {exception.Message}", "NGettext");
			}
#else
...
#region ICatalog implementation
		...
		public virtual string GetPluralStringDefault(string messageId, string defaultMessage, string defaultPluralMessage, long n)
		{
			...
			{
#if DEBUG
				Trace.WriteLine($"Translation not found (plural) for message id \"{messageId}\".", "NGettext");
#endif
