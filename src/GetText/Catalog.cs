...
namespace GetText
{
    ...
    public class Catalog : ICatalog
    {
        ...
        {
            get => formatProvider;
            set => formatProvider = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        {
            get => pluralRule;
            set => pluralRule = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        {
            return GetStringDefault(text?.String, text?.String);
        }
        ...
        {
            return string.Format(FormatProvider, GetStringDefault(text?.Format, text?.Format), text.GetArguments());
        }
        ...
        {
            return string.Format(FormatProvider, GetStringDefault(text?.String, text?.String), args);
        }
        ...
        {
            return string.Format(FormatProvider, GetPluralStringDefault(text?.Format, text?.Format, pluralText?.Format, n), n == 1 ? text.GetArguments() : pluralText.GetArguments());
        }
        ...
        {
            return string.Format(FormatProvider, GetPluralStringDefault(text?.String, text?.String, pluralText?.String, n), args);
        }
        ...
        {
            return GetStringDefault(context + CONTEXTGLUE + text?.String, text?.String);
        }
        ...
        {
            return string.Format(FormatProvider, GetStringDefault(context + CONTEXTGLUE + text?.Format, text?.Format), text.GetArguments());
        }
        ...
        {
            return string.Format(FormatProvider, GetPluralStringDefault(context + CONTEXTGLUE + text?.Format, text?.Format, pluralText?.Format, n), n == 1 ? text.GetArguments() : pluralText.GetArguments());
        }
        ...
        {
            return string.Format(FormatProvider, GetPluralStringDefault(context + CONTEXTGLUE + text?.String, text?.String, pluralText?.String, n), args);
        }
        ...
        {
            string[] translations = TryGetTranslations(messageId);
        ...
        {
            string[] translations = TryGetTranslations(messageId);
            int pluralIndex = PluralRule.Evaluate(n);
        ...
        {
            if (!TranslationExists(messageId))
                return null;
        ...
        public virtual bool TranslationExists(string messageId)
        {
            ...
            return Translations.ContainsKey(messageId);
        }
    }
}