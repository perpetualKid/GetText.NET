        ...
        public void SetState(object obj, string propertyName, object value)
        {
            ...
            if (value == null)
            {
                ...
                if (pi != null && pi.CanRead)
                    ...
                    throw new InvalidOperationException($"Property '{propertyName}' not exists or write-only. Object: {obj}");
            }
            if (!store.TryGetValue(obj.GetHashCode(), out PropertiesValuesStore propStore) || propStore == null)
            {
