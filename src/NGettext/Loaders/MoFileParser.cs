...
#if DEBUG
                Trace.WriteLine($"MO File Revision: {parsedFile.FormatRevision.Major}.{parsedFile.FormatRevision.Minor}.", "NGettext");
#endif
...
#if DEBUG
                Trace.WriteLine($"MO File contains {stringCount} strings.", "NGettext");
#endif
...
#if DEBUG
                Trace.WriteLine($"Trying to parse strings using encoding \"{parsedFile.Encoding}\"...", "NGettext");
#endif
...
#if DEBUG
                                    Trace.WriteLine($"File encoding switched to \"{parsedFile.Encoding}\" (\"{contentType.CharSet}\" requested).", "NGettext");
#endif
                                }
                            }
