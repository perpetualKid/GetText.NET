...
namespace NGettext.Loaders
{
    ...
    internal sealed class ReadOnlyStream : Stream
    {
        ...
        /// <exception cref="IOException">An I/O error occurs. </exception><exception cref="NotSupportedException">The stream does not support seeking, such as if the stream is constructed from a pipe or console output. </exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="buffer"/> is null. </exception><exception cref="ArgumentOutOfRangeException"><paramref name="offset"/> or <paramref name="count"/> is negative. </exception>
        /// <exception cref="IOException">An I/O error occurs. </exception><exception cref="NotSupportedException">The stream does not support reading. </exception>
        /// <exception cref="ObjectDisposedException">Methods were called after the stream was closed. </exception>
        /// <filterpriority>1</filterpriority>
        ...
        /// <exception cref="ArgumentException">One or more of the arguments is invalid. </exception><exception cref="ObjectDisposedException">Methods were called after the stream was closed. </exception>
        ...
        /// <exception cref="ArgumentException"><paramref name="asyncResult"/> did not originate from a <see cref="Stream.BeginRead(byte[], int, int, AsyncCallback, object)"/> method on the current stream. </exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="asyncResult"/> is null. </exception>
        /// <exception cref="ArgumentException"><paramref name="asyncResult"/> did not originate from a <see cref="Stream.BeginWrite(byte[], int, int, AsyncCallback, object)"/> method on the current stream. </exception>
        /// <exception cref="IOException">The stream is closed or an internal error has occurred.</exception>
        /// <filterpriority>2</filterpriority>
